...
class PmergeMe
{
    ...
    public:
        ...
        void    insertion(std::vector<int>& main, std::vector<std::pair<int, int>>& pairs);
        size_t    findPartner(size_t a, std::vector<std::pair<int, int>>& pairs);
        std::vector<size_t>	generateJacobsthal(size_t pairSize);
